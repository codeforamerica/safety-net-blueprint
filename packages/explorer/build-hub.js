 ...
 * build-hub.js
 *
 * Generates packages/explorer/index.html.
...
const apiPages      = scanPages(join(toolsDir, 'api-reference'));
const dictPages     = scanPages(join(toolsDir, 'data-dictionaries'));
const clientPages   = scanPages(join(toolsDir, 'client-reference'));
const smPages       = scanPages(join(toolsDir, 'state-machine-docs'));
const contextPages  = scanPages(join(diagramsDir, 'context-map'), contextMapLabel)
  .filter(p => p.slug.startsWith('domain_'));
const seqPages      = scanPages(join(diagramsDir, 'sequence-diagrams'))
  .filter(p => p.slug !== 'application-submission' || true); // include all
...
<head>
  ...
  <title>Safety Net Blueprint — Explorer</title>
  <style>
    :root {
      --dark-blue:    #2B1A78;
      --mid-blue:     #5650BE;
...
<body>
  ...
  <header>
    <div class="wordmark">
      ...
      <h1>Safety Net Blueprint</h1>
    </div>
    <nav>
      <a href="https://github.com/codeforamerica/safety-net-blueprint">GitHub</a>
    </nav>
  </header>
  ...
  <div class="hero">
    ...
    <p>Diagrams, tools, and reference outputs for the Safety Net Blueprint — a shared contract layer for state benefits programs.</p>
    <div style="margin-top:1.5rem;display:flex;justify-content:center;align-items:center;gap:0.5rem;flex-wrap:wrap;">
      ...
      <a href="diagrams/adoption-model/executive-summary.html" style="font-size:12.5px;font-weight:600;color:white;text-decoration:none;background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.25);padding:0.3rem 0.875rem;border-radius:100px;">Executive Summary</a>
      <a href="diagrams/adoption-model/adoption-model.html" style="font-size:12.5px;font-weight:600;color:white;text-decoration:none;background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.25);padding:0.3rem 0.875rem;border-radius:100px;">Slide Deck</a>
    </div>
  </div>
    ...
    <div class="card-grid">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-header-row">
            <h4><a href="tools/api-reference/index.html" class="card-link">API Reference</a></h4>
            <span class="status-badge badge-progress">In progress</span>
          </div>
          <p>Static reference for all contract APIs — endpoints, parameters, request and response schemas. No running mock server required.</p>${outputTags(apiPages, 'tools/api-reference', 'dot-green')}
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-header-row">
            <h4><a href="tools/data-dictionaries/index.html" class="card-link">Data Dictionary</a></h4>
            <span class="status-badge badge-progress">In progress</span>
          </div>
          <p>Field-level reference for the blueprint data model — types, enums, relationships, and annotations from the OpenAPI specs.</p>${outputTags(dictPages, 'tools/data-dictionaries', 'dot-green')}
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-header-row">
            <h4><a href="tools/client-reference/index.html" class="card-link">Client Reference</a></h4>
            <span class="status-badge badge-progress">In progress</span>
          </div>
          <p>Generated TypeScript client reference — SDK functions, types, and Zod schemas for each domain, with search helper documentation.</p>${outputTags(clientPages, 'tools/client-reference', 'dot-grey')}
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-header-row">
            <h4><a href="tools/state-machine-docs/index.html" class="card-link">State Machine Docs</a></h4>
            <span class="status-badge badge-progress">In progress</span>
          </div>
          <p>Generated reference for the state machines defined in the blueprint contracts — states, transitions, actions, and event subscriptions.</p>${outputTags(smPages, 'tools/state-machine-docs', 'dot-blue')}
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-header-row">
            <h4><a href="tools/event-catalog/index.html" class="card-link">Event Catalog</a></h4>
            <span class="status-badge badge-progress">In progress</span>
          </div>
    ...
    <div class="card-grid">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-header-row">
            <h4><a href="diagrams/context-map/domains.html" class="card-link">Context Map</a></h4>
            <span class="status-badge badge-progress">In progress</span>
          </div>
          <p>Visual map of the bounded contexts, systems, and integration relationships across the safety net platform.</p>${outputTags(contextPages, 'diagrams/context-map', 'dot-blue')}
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-header-row">
            <h4><a href="diagrams/sequence-diagrams/index.html" class="card-link">Sequence Diagrams</a></h4>
            <span class="status-badge badge-progress">In progress</span>
          </div>
          <p>Contract-driven event chain diagrams tracing how a triggering action propagates across domain boundaries.</p>${outputTags(seqPages, 'diagrams/sequence-diagrams', 'dot-blue')}
        </div>
      </div>
