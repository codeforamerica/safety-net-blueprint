...
/**
 * Load all *-asyncapi.yaml files from a directory (recursively) and return:
...
async function main() {
  ...
  const stateMachineFiles = walkForPattern(specDir, '-state-machine.yaml');
