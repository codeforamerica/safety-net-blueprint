// Auto-generated from authored/contracts/application/colorado-field-requirements.form.yaml. Run `npm run generate:stories` to regenerate.
...
// Layout
import contract from '../../authored/contracts/application/colorado-field-requirements.form.yaml';
import layoutYaml from '../../authored/contracts/application/colorado-field-requirements.form.yaml?raw';
...
import schemaSpecData from '../../generated/openapi/colorado-benefits-schema.yaml';
import schemaSpecYaml from '../../generated/openapi/colorado-benefits-schema.yaml?raw';
...
const annotationLayers = [
  ...
  { name: 'colorado', data: annotationLayer1 as unknown as Record<string, unknown> },
];
...
const meta: Meta = {
  title: 'Reference/Colorado Field Requirements',
...
function StoryWrapper() {
  ...
  const tabs: EditorTab[] = [
    { id: 'layout', label: 'Layout', filename: 'authored/contracts/application/colorado-field-requirements.form.yaml', source: layoutYaml },
    { id: 'schema-spec', label: 'OpenAPI Schema', filename: 'generated/openapi/colorado-benefits-schema.yaml', source: schemaSpecYaml, readOnly: true, group: 'reference' as const },
  ...
  return (
    <ContractPreview
      tabs={tabs}
      contractId="application-colorado-field-requirements"
      formTitle="Colorado Field Requirements"
...
export const ApplicationColoradoFieldRequirements: StoryObj = {
  name: 'Colorado Field Requirements',
  render: () => <StoryWrapper />,
};
