...
import { resolveRef, collectTopLevelProperties, resolveSchemaRefs } from '../src/validation/state-machine-validator.js';
...
export function buildCollectionSchemaMap(specsDir) {
  ...
  for (const file of files) {
    ...
    const slaRel = relative(resolve(specsDir), specFilePath);
