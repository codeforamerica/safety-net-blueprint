 ...
 * collectTopLevelProperties, getPropertyAtPath) live in ./state-machines.
 */

// OpenAPI structural validation
export { validateSpec, validateAll, formatResults, getValidationStatus } from './validation/openapi-validator.js';
...
export { deriveSchemaName, validateExamples } from './validation/example-validator.js';
...
} from './validation/state-machine-validator.js';
